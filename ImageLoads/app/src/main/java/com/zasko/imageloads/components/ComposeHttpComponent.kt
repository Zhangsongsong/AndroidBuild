...
object ComposeHttpComponent {
    ...
    suspend fun getTaoTu(url: String = "https://taotu.org/"): String {
        return ioRequest {
            imageServer.getTaoTu(url = url)
        }
    }
...
private interface ComposeImageLoadsServices {
    ...
    @Headers(
        ...
        "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8",
        "Accept-Language: zh-CN,zh;q=0.9,en;q=0.8",
        "Referer: https://taotu.org/",
    )
    suspend fun getTaoTu(@Url url: String = "https://taotu.org/"): String
    ...
    @Headers(
        ...
        "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8",
        "Accept-Language: zh-CN,zh;q=0.9,en;q=0.8",
        "Referer: https://trendszine.com/",
    )
    suspend fun getTrendszine(@Url url: String = "https://trendszine.com/"): String
}
